...
extern int16_t l_filter_speed;
extern int16_t r_filter_speed;
extern int16_t l_real_speed;
extern int16_t r_real_speed;
extern int32_t r_s;
extern int32_t l_s;
extern int32_t S_s;
extern int32_t a;
...
void level_control(void);//水平电感循迹

void motor_error(void);
void motor_control(void);
void hj(void);
uint16_t L_EncoderAverageFilter(uint16_t nowdata);
uint16_t R_EncoderAverageFilter(uint16_t nowdata);
