...
#define TFTSPI_CS     PT7_20    //CS   E12  
#define TFTSPI_SCL    PT7_21    //SCL  D12
#define TFTSPI_SDA    PT7_26    //SDI  B13 
#define TFTSPI_DC     PT7_15    //DC   E11
#define TFTSPI_RST    PT7_19    //RST  D11 


void TFTSPI_Init(uint8_t type)
{ 	
  //-----端口初始化----//
	FASTPIN_InitConfig(E12, PIN_MODE_OUTPUT, 0);
	FASTPIN_InitConfig(D12, PIN_MODE_OUTPUT, 0);
	FASTPIN_InitConfig(B13, PIN_MODE_OUTPUT, 0);
	FASTPIN_InitConfig(E11, PIN_MODE_OUTPUT, 0);
	FASTPIN_InitConfig(D11, PIN_MODE_OUTPUT, 0);
