...
#define OLED_DC_Clr()  gpio_bit_write(GPIOB, OLED_DC, RESET)
#define OLED_DC_Set()  gpio_bit_write(GPIOB, OLED_DC, SET)
 					   
#define OLED_RST_Clr()  gpio_bit_write(GPIOB, OLED_RST, RESET)
#define OLED_RST_Set()  gpio_bit_write(GPIOB, OLED_RST, SET)
...
void OLED_show_ascii(uint8_t ascii_buffer[16],uint8_t line_num);
void OLED_show_ascii_half(uint8_t ascii_buffer[16],uint8_t line_num);
void OLED_show_chinese(uint8_t chinese_buffer[32],uint8_t line_num);
#endif
