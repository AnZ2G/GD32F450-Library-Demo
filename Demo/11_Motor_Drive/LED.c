...
/* 类型定义 */
static uint32_t GPIO_PORT_LED[LEDn] = {LED1_GPIO_PORT, LED2_GPIO_PORT,LED3_GPIO_PORT};

static uint32_t GPIO_PIN_LED[LEDn] = {LED1_PIN, LED2_PIN, LED3_PIN};

static rcu_periph_enum GPIO_CLK_LED[LEDn] = {LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK};
...
void LED_Init(led_typedef_enum lednum)
{
    ...
    else
    {
        ...
        gpio_output_init(GPIOD, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2);
        gpio_set_output(GPIOD, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2, 0);
    }
}
...
void LED_Off(led_typedef_enum lednum)
{
    ...
    {
        gpio_set_output(GPIOD, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2, 1);
    }
}
...
void LED_Toggle(led_typedef_enum lednum)
{
    ...
    {
        gpio_toggle(GPIOD, GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2);
    }
}
